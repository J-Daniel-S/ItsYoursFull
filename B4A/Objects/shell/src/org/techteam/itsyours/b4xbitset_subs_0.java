...
try {
		Debug.PushSubsStack("Clear (b4xbitset) ","b4xbitset",8,__ref.getField(false, "ba"),__ref,53);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (org.techteam.itsyours.b4xbitset.class, "_clear" /*RemoteObject*/ );
